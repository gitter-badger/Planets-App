...
public class MainActivity extends FragmentActivity {
	...
	// set up arrays from String resources in order to dynamically build a PlanetFragment. These get passed in via the MyAdapter constructor
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		viewPager.setAdapter(new MyAdapter(getSupportFragmentManager(),sun, mercury,venus,earth,mars,jupiter,saturn,uranus,neptune));
	}
	...
	public void onWindowFocusChanged(boolean hasFocus) {
		...
		// shorthand for what you previously had here. When you evaluate an IF statement it checks to see if what you have placed inside the parenthesis evaluates to true or false
		if (box) {
			getWindow()
...
class MyAdapter extends FragmentStatePagerAdapter {
	...
	private static final String[] PLANETS = {"Sun","Mercury","Venus","Earth","Mars","Jupiter","Saturn","Uranus","Neptune"};
	...
	public MyAdapter(FragmentManager fm,String[]sun, String[] mercury, String[] venus, String[] earth, String[] mars, String[] jupiter, String[] saturn, String[] uranus, String[] neptune) {
		super(fm);
		this.SUN = sun;
	...
	// Use one PlanetFragment and dynamically build it according to the items in the corresponding array.
	@Override
	...
	// Use the previously found item in the PLANETS array and return the array with that planet name
